...
> **Before first use:** every `you@university.edu` / `your@email.com` in the examples below is a
> placeholder. Replace it with your own email address. OpenAlex, CrossRef and Unpaywall use it to
> identify polite-pool traffic — CrossRef gives 50 req/sec with it versus 1 req/sec without, and
> Unpaywall rejects requests that omit it. No API key or registration is needed.
